...
do
	if [[ $opt = "" ]]; then 
		...
		1) clear;
			...
			(cd MapReduce/src/analysis1 ; bash analysis1.sh)
			show_menu;
		;;
		2) clear;
		...
		5) clear;
			...
			(cd MapReduce/src/analysis5 ; bash analysis5.sh)
			show_menu;
		;;
		6) clear;
		...
		11) clear;
			...
			(cd MapReduce/src/analysis11 ; bash analysis11.sh)
			show_menu;
		;;
		12) clear;
			...
			(cd MapReduce/src/analysis12 ; bash analysis12.sh)
			show_menu;
		;;
		13) clear;
